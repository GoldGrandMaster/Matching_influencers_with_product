...
const AddInfluencerModal = ({
    ...
    const handleDelete = () => {
        new Promise((resolve: any, reject: any) => {
            axios.delete(`${backend_url}/delete_data_influencers`, {
    ...
    const handleUpdate = () => {
        ...
        new Promise((resolve: any, reject: any) => {
            axios.post(`${backend_url}/update_data_influencers`, { data: formdata, _id: initData["_id"]["$oid"] })
                .then(res => {
                    console.log(res.data);
                    resolve();
                })
    ...
    return <Dialog
        ...
        PaperProps={{
            ...
            onSubmit: (event: React.FormEvent<HTMLFormElement>) => {
                ...
                new Promise((resolve: any, reject: any) => {
                    axios.post(`${backend_url}/add_data_influencers`, formJson)
                        .then((res) => {
                            console.log(res.data);
                            resolve();
                        })
